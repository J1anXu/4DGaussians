...
f = "/data2/jian/4DGS_ADMM/output/admm_quant_1/cook_spinach/point_cloud/iteration_23001"
print_all_file_sizes(f)


f = "/data2/jian/4DGS_ADMM/output/admm_1/cook_spinach/point_cloud/iteration_21000"
print_all_file_sizes(f)
