    ...
    for iteration in range(first_iter, final_iter + 1):
        ...
        with torch.no_grad():
            ...
            if iteration < opt.densify_until_iter:
                ...
                imp_score = blending_weight(gaussians, opt, scene, pipe, background, cache=True)
                ...
                # imp_score = time_0_bleding_weight(gaussians, opt, scene, pipe, background)  # 这里不能cache
                imp_score = topk_gs_of_pixels_score(gaussians, scene, pipe, background, args.related_gs_num)
