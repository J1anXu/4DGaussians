...
def scene_reconstruction(
    ...
    for iteration in range(first_iter, final_iter + 1):
        ...
        with torch.no_grad():
            ...
            if iteration > opt.admm_start_iter1 & iteration % opt.admm_interval == 0:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint_iterations", nargs="+", type=int, default=[6000, 8000, 10000, 12000, 14000])
    ...
    run = wandb.init(
        project="train",
        name=current_time,  # 让不同脚本的数据归为一组
        job_type="training",
