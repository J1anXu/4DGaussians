...
def render(viewpoint_camera, pc : GaussianModel, pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, override_color = None, stage="fine", cam_type=None, gs_topk = 0):
    """
    Render the scene. 
    ...
    # time3 = get_time()
    rendered_image, radii, accum_weights_ptr, accum_weights_count, accum_max_count, important_score= rasterizer(
