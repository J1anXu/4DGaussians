	...
	)
{
  ...
  return std::make_tuple(rendered, out_color, out_depth, accum_weights_ptr, accum_weights_count, accum_max_count,radii, geomBuffer, binningBuffer, imgBuffer, accum_scores_ptr);
}
