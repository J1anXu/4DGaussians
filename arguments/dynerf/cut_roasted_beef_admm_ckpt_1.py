...
OptimizationParams = dict(
    ...
    admm_start_iter1=0,  # admm迭代开始
    admm_stop_iter1=0,  # admm迭代结束 19400
    simp_iteration2=0,  # 删点执行 19401
    iterations=15000,  # 整体迭代
    admm_interval=50,
    rho_lr=0.0005,
    ...
    admm=True,
    related_gs_num=1,
    simp_iteration1_score_type = 4, # 不用改
...
#     simp_iteration2=25001,  # 删点执行 19401
#     iterations=26000,  # 整体迭代
#     admm_interval=50,
#     rho_lr=0.0005,
#     opacity_admm_threshold1=0.50,  # 0.8
#     opacity_admm_threshold2=0.80,
#     coarse_iterations=0,
#     outdoor=False,
#     prune_points=True,  # 是否进行删点
#     admm=True,
